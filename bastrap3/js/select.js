	//Script para los desplegables con dependencia
		...
		document.getElementById('iInterno').value = "0"; //Seteando valor del interno por defecto
		...
		document.getElementById('divMoto').style.display="none";
		...
		if(form.tipo[1].selected){
			...
			document.getElementById('divParticular').style.display="inline";
			...
			//Validando si marca y modelo es otro así se habilita un input
			if($('#marcaParticular option:selected').text() == "Otra Marca"){
			...
			//modelo se valida en un script aparte
		}
...
// ******************************************************************************************************************************************
			...
			if(form.tipo[2].selected){
				//Se activa el check de titular
				document.getElementById("divEsTitular").style.display = "inline";
				//Ocultando y mostrando los SELECT correspondientes a moto
				document.getElementById('divParticular').style.display="none";
				form.marcaSinSeleccion.style.display = "none";
				document.getElementById('divMoto').style.display="inline";
				form.modeloP.style.display = "none";
				...
				//Validando si marca y modelo es otro así se habilita un input
				if($('#marcaMoto option:selected').text() == "Otra Marca"){
					document.getElementById('iMarca').style.display="inline";
					form.modeloM.style.display = "none";
					document.getElementById('iModelo').style.display="inline";
					document.getElementById('iModelo').value="";
			...
			else{ //Si no es moto se oculta el check de titular
				$('input[name=esTitular]').attr('checked',false);
				document.getElementById("divEsTitular").style.display = "none";
			}
...
// ******************************************************************************************************************************************
		...
		//	var lineaColectivo = [{ text: '', value: ''}];
			if(form.tipo[7].selected){
				$('#tipoDominio option:eq(0)').prop('selected', true);
				document.getElementById('tipoDominio').style.display="none";
				...
				document.getElementById('divLinea').style.display="inline";
				//Cambiando el valor de las marcas de otras categorías a 0 ("Seleccionar")
				$('#marcaParticular option:eq(0)').prop('selected', true);
				$('#marcaMoto option:eq(0)').prop('selected', true);
			...
			if(form.tipo[3].selected || form.tipo[4].selected || form.tipo[5].selected || form.tipo[6].selected || form.tipo[8].selected || form.tipo[9].selected || form.tipo[10].selected){
				$('#tipoDominio option:eq(0)').prop('selected', true);
			...
			//Validando patente desde otros campos
			...
			if( $('#dominio').css('display') == 'none' ){
				if(form.tipoDominio[5].selected) document.getElementById("tipoDominio").disabled = false;
				else document.getElementById("tipoDominio").disabled = true;
				document.getElementById('dominio').value = "SIN PATENTE";
			}
			if( $('#dominio').css('display') != 'none' ){
				document.getElementById("tipoDominio").disabled = false;
				if(document.getElementById('dominio').value == "SIN PATENTE") document.getElementById('dominio').value = "";
			}
			
			//Validando tipo de dominio, marca y modelo para que sea REQUIRED
			if( $('#marcaSinSeleccion').css('display') == 'none' ){
			...
			if( $('#divParticular').css('display') == 'none' ){
			...
			if( $('#iTipo').css('display') == 'none' ) {
				document.getElementById("iTipo").required = false;
				document.getElementById("iTipo").disabled = true;
			}
			else{
				document.getElementById("iTipo").required = true;
				document.getElementById("iTipo").disabled = false;
			}
			if( $('#iMarca').css('display') == 'none' ) document.getElementById("iMarca").disabled = true;
			else document.getElementById("iMarca").disabled = false;
			if( $('#iModelo').css('display') == 'none' ) document.getElementById("iModelo").disabled = true;
			else document.getElementById("iModelo").disabled = false;
			if( $('#modeloP').css('display') == 'none' ) document.getElementById("modeloP").required = false;
			else document.getElementById("modeloP").required = true;
			if( $('#modeloM').css('display') == 'none' ) document.getElementById("modeloM").required = false;
			else document.getElementById("modeloM").required = true;
			//Tipo de dominio required excepto en colectivo
			if(form.tipo[7].selected) document.getElementById("tipoDominio").required = false;
			else document.getElementById("tipoDominio").required = true;
